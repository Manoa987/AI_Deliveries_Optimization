...
public class Controller {
	...
	public void addRequest() {
		try {
			System.out.println("rentre dans add request du controller " + this.getCurrentState().toString());
	...
	public void validerRequest() {
		System.out.println("rentre dans validerRequest du controller");
		currentState.validerRequest(this, window, carte, listOfCommands);
	}

	public void modifRequest() {
		System.out.println("rentre dans modifRequest du controller");
		currentState.modifRequest(this, window, carte);
	}

	public void annulerAction() {
		System.out.println("rentre dans annulerAction du controller");

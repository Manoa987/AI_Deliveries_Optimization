...
public class Carte extends Observable {
    ...
    public void loadMap(File xmlFile) throws Exception {
        ...
        this.segmentList = xmLdeserializer.loadSegmentDataFromXml(xmlFile);
        ...
        System.out.println("maxLong :" + this.calcMaxLong());
        System.out.println("minLong :" + this.calcMinLong());
        System.out.println("maxLat :" + this.calcMaxLat());
        System.out.println("minLat :" + this.calcMinLat());
        System.out.println("nbSeg :" + this.getSegmentList().size());
        System.out.println("nbInter :" + this.getIntersectionList().size());

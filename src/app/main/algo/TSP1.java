	...
	public double bound(Integer currentVertex, Collection<Integer> unvisited, double[][] cout, int nombre, int version) {
		...
		switch (version) {
			...
			case 1:
				...
				//System.out.println("BOUND : " + minDistance);
				return minDistance * nbUnvisited;//return 0;
			// Version 2
			case 2:
			...
			case 3:
				...
				System.out.println("minIn : " + minIn+ ", minOut : " + minOut + ", minBound : " + minBound);
			...
			case 4:
				...
				System.out.println("minIn : " + minIn + ", minOut : " + minOut + ", minTree : " + minTree);
